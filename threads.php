...
<head>
    ...
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/highlight.js/10.1.1/languages/1c.min.js">
    </script>
    <script>
...
<body>
  ...
  ?>
    ...
    <div class="container mt-1">
        <h4 class="display-4" style="font-size:30px">Code submitted by-<?php echo$dispusnm?></h4>
        <br>
        <pre><code class="cpp" style="height:400px" >
