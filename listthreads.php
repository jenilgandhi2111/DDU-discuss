...
$sql="INSERT INTO `threads` (`thread_id`, `thread_title`, `thread_desc`, `thread_cat_id`, `thread_user_id`, `timestamp`) VALUES (NULL, '$current_title', '$current_desc', '$catid', '$user_id', current_timestamp())";
$result=mysqli_query($conn,$sql);
...
<body>
  ...
  <hr class="my-4">
  <p>These are the special forums for the students of Dharamsinh Desai University.Kindly use it for only discussions and rules are as listed below</p>
...
<form method="post" action="listthreads.php?cat_id='.$catid.'">
  ...
  <div class="form-group display-4">
    <label for="exampleFormControlTextarea1"  style="font-size:20px">Question description</label>
    <textarea class="form-control"style="height:235px" id="exampleFormControlTextarea1" name="current_desc" rows="3"></textarea>
  </div>
